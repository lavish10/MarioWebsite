...
var Mario,stage1,stage1_1,stage1_2,stage1_3,stage1_4,W,H,Block,Blocksheet,Blockimg,Blockcopy1,Blockcopy2,Blockwidth;
//var skyimg,darkskyimg,sunimg,gateimg,guardimg,dudeimg,bubbleimg;
var monster,monstersheet,monsterimg,monstercopy1,monstercopy2;
var rightpositionflag;
var Marioimg,stage1img,stage1_1img,stage1_2img,stage1_3img,stage1_4img;
var frame;
...
function init() {
	...
	{src:"../resources/MarioSS.png",id:"Mario"},
	{src:"../resources/q.png",id:"Basebg"},
	{src:"../resources/bg5.png",id:"Enemybg"},
	{src:"../resources/bbgg1.png",id:"Blocks"},
	{src:"../resources/bg6.png",id:"Homebg"},
...
function initFrameElements()
{
	...
	stage1_4img=loader.getResult("Enemybg");
     ...
     framerate: 15,
     images: [Marioimg],
     frames: {width:17.428, height:32, count:7, regX:0, regY:0, spacing:0, margin:0
     },
...
function right(){
	...
	if(x<changeWH(1,170)&&x>changeWH(1,90))
	setanimation(Block,"after",Block.currentanimation);
else if(x<changeWH(1,275)&&x>changeWH(1,200))
	setanimation(Blockcopy1,"after",Blockcopy1.currentanimation);
else if(x<changeWH(1,400)&&x>changeWH(1,310))
...
function play5(event)
{
	...
	setanimation(monster,"before",monstercopy2.currentanimation);
	 ...
	 if(x>a && x<a+W/17+W/15)
	setanimation(monster,"after",monster.currentanimation);
else if(x>b && x<b+W/17+W/15)
	setanimation(monstercopy1,"after",monstercopy1.currentanimation);
else if(x>c && x<c+W/17+W/15)
	setanimation(monstercopy2,"after",monstercopy2.currentanimation);
else
	{setanimation(monstercopy2,"before",monstercopy2.currentanimation);
	setanimation(monstercopy1,"before",monstercopy2.currentanimation);
